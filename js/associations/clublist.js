...
function buildNewClub(item, index) {
  ...
  listItemName.html('<a id="' + item.clubName + '"><h1>' + item.clubName + '</h1></a> <a href="#sommaire"><h1>Revenir au sommaire</h1></a>');
...
function buildNewAsso(item, index) {
  ...
  var listItemName = $('.nameContainer', listItem);
  listItemName.html('<a id="' + item.BDX + '"><h1>' + item.assoName + '</h1></a> <a href="#sommaire"><h1>Revenir au sommaire</h1></a>');
  var listItemImage = $('.imageContainer', listItem);
